...
class Neutral(object):
    def __init__(self, gateway, pipe, frameskip=False):
        ...
        print("Neutral.__init__() was called.")
    ...
    def initialize(self, gameData, player):
        ...
        print("Neutral.initialize() was called.")
        ...
        print("Neutral.initialize() was successful.")
    ...
    def roundEnd(self, x, y, z):
        ...
        print("Neutral.roundEnd() was called.")
    ...
    def getScreenData(self, sd):
        ...
        print("Neutral.getScreenData() was called.")

        self.screenData = sd

    def getInformation(self, frameData, isControl, nonDelay):

        print("Neutral.getInformation() was called.")
    ...
    def input(self):
        ...
        print("Neutral.input() was called.")
    ...
    def processing(self):
        ...
        print("Neutral.processing() was called.")
    ...
    def get_obs(self):
        ...
        print("Neutral.get_obs() was called.")
